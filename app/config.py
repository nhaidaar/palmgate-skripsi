...
DEVICE_PREVIEW_FRAME_INTERVAL_MS = int(os.getenv("DEVICE_PREVIEW_FRAME_INTERVAL_MS", "100"))
...
USB_REGISTRATION_CAPTURES = 7
USB_REGISTRATION_STORE_EMBEDDINGS = 5
USB_REGISTRATION_MIN_VALID = 5
USB_REGISTRATION_MIN_BLUR = 100.0
